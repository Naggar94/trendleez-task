...
<html>
	...
	<head>
		...
		<link href="<?= URL::to('/public/assets/vendors/custom/datatables/datatables.bundle.css') ?>" rel="stylesheet" type="text/css" />
		...
		<script src="<?= URL::to('/public/assets/vendors/custom/datatables/datatables.bundle.js') ?>" type="text/javascript"></script>
		...
		<div class="kt-grid kt-grid--hor kt-grid--root">
			...
			-->
					...
					<div class="kt-aside-menu-wrapper kt-grid__item kt-grid__item--fluid" id="kt_aside_menu_wrapper">
						<div id="kt_aside_menu" class="kt-aside-menu kt-scroll ps ps--active-y ps--active-x" data-ktmenu-vertical="1" data-ktmenu-scroll="1" data-ktmenu-dropdown-timeout="500" style="height: 198px; overflow: hidden;">
							<ul class="kt-menu__nav ">
								<li class="kt-menu__item " aria-haspopup="true"><a href="<?=URL::to('/')?>" class="kt-menu__link "><span class="kt-menu__link-icon"><i class="fa fa-home"></i></span><span class="kt-menu__link-text">Home</span></a></li>
							</ul>
						</div>
					</div>
				...
				<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor kt-wrapper" id="kt_wrapper">
					...
					<div id="kt_header" class="kt-header kt-grid__item  kt-header--fixed ">
						...
						<div class="kt-header__topbar">
							...
							<a href="<?=URL::to('login')?>" class="kt-header__topbar-item kt-header__topbar-item--user">
								<div class="kt-header__topbar-wrapper">
									<div class="kt-header__topbar-user">
										<span class="kt-header__topbar-welcome kt-hidden-mobile">Login</span>
									</div>
								</div>
							</a>
							<?php }else{ ?>
								...
								<div class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-top-unround dropdown-menu-xl">
									...
									<div class="kt-notification">
										<div class="kt-notification__custom kt-space-between">
											<a href="<?=URL::to('logout')?>"  class="btn btn-label btn-label-brand btn-sm btn-bold">Sign Out</a>
										</div>
									</div>
